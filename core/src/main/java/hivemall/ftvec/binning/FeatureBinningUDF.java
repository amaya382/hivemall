    ...
    public ObjectInspector initialize(ObjectInspector[] OIs) throws UDFArgumentException {
        ...
        if (HiveUtils.isListOI(OIs[0]) && HiveUtils.isMapOI(OIs[1])) {
            ...
            if (!HiveUtils.isStringOI(quantilesMapOI.getMapKeyObjectInspector())
                    || !HiveUtils.isListOI(quantilesMapOI.getMapKeyObjectInspector())
                    || !HiveUtils.isNumberOI(((ListObjectInspector) quantilesMapOI.getMapKeyObjectInspector()).getListElementObjectInspector())) {
        ...
        if (multiple) {
            ...
            if (quantilesMap == null) {
                ...
                for (Object _key : _quantilesMap.keySet()) {
                    ...
                    final double[] val = HiveUtils.asDoubleArray(_quantilesMap.get(key), quantilesOI,
                        quantileOI);
